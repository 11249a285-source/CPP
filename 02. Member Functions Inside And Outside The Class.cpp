...
1.Start the program.
2.Create a class Rectangle with private data members length and breadth.
3.Define a function setData() to assign values to length and breadth.
4.Define a function area() to calculate and return the area (length * breadth).
5.In the main() function, create an object of the Rectangle class.
